...
Ordered by priority: the groundwork that makes the rest affordable first, then
features we don't have. Everything below was checked against the v2 OpenAPI spec
